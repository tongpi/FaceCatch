(function(root, factory) {
  ...
  var BootstrapDialogModal = function(element, options) {
    if(/4\.1\.\d+/.test($.fn.modal.Constructor.VERSION)) {
  ...
  BootstrapDialog.prototype = {
    ...
    updateType: function() {
      if(this.isRealized()) {
        var types = [BootstrapDialog.TYPE_DEFAULT, BootstrapDialog.TYPE_INFO, BootstrapDialog.TYPE_PRIMARY, BootstrapDialog.TYPE_SECONDARY, BootstrapDialog.TYPE_SUCCESS, BootstrapDialog.TYPE_WARNING, BootstrapDialog.TYPE_DARK, BootstrapDialog.TYPE_LIGHT, BootstrapDialog.TYPE_DANGER];
    ...
    updateSize: function() {
      if(this.isRealized()) {
        var dialog = this;
        this.getModal().removeClass(BootstrapDialog.SIZE_NORMAL).removeClass(BootstrapDialog.SIZE_SMALL).removeClass(BootstrapDialog.SIZE_WIDE).removeClass(BootstrapDialog.SIZE_EXTRAWIDE).removeClass(BootstrapDialog.SIZE_LARGE);
